...
class CardSelector extends StatefulWidget {
  ...
  ///
  /// The [lastCardSizeFactor] is the factor of the last element to render
  /// compare to the first element.
  CardSelector({
    required this.cards,
    required this.onChanged,
    this.mainCardWidth = 0,
    this.mainCardHeight = 190,
...
print('wid:$_cards');
  ...
  Widget lastCardPreview() {
    var lastCardAnimDuration = Duration(milliseconds: widget.cardAnimationDurationMs);
  ...
  Widget cardWidget(Widget w, int position) {
    ...
    if (position > positionFirstCard) {
      var idx = cardListLength - position + positionFirstCard;
      var leftPosAlignRight = widget.mainCardPadding + widget.mainCardHeight - cardHeight;

      leftPadding = leftPosAlignRight +
          (position - positionFirstCard) * scaleBetween(idx, widget.cardsGap, widget.cardsGap / 2, 0, cardListLength - positionFirstCard);


      // print('positionFirstCard:${positionFirstCard}');
      // print('cardsGap/2:${widget.cardsGap / 2}');
      // print('cardsGap:${widget.cardsGap}');
      // print('cardListLength:${cardListLength - positionFirstCard}');
      // print('----------');
    }
    ...
    if (position == 0 && csState == CardSelectorState.target) {
      ...
      leftPadding = -widget.mainCardHeight;
    }
    ...
    return AnimatedPositioned(
      ...
      duration: Duration(milliseconds: (150 * 1.5).round()),
      curve: Curves.easeOut,
      top: (widget.mainCardWidth - cardWidth) / 2,
      left: leftPadding,
